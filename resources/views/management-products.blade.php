                    ...
                    <section class="py-10 px-5 lg:px-10 space-y-8">
                        ...
                        <div class="flex flex-1 gap-10 flex-col">
                            ...
                            < count($products); $i++)
                                ...
                                :image_source="count($products[$i]->default_pictures) > 0 ?asset('storage/'.$products[$i]->default_pictures[0]['picture_storage_key']):asset('images/basket.svg')"
                            ...
                            <x-management-link
                                ...
                                :deletion_href="''"
                                :image_source="asset('images/new.svg')"
